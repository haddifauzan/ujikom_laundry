...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-scroller">
        @include('karyawan.kasir.template.navbar')
        @include('karyawan.kasir.template.sidebar')
        @include('karyawan.kasir.template.content')
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="profileOffcanvas">
              ...
              <div class="offcanvas-body">
                ...
                <div class="profile-info">
                  <form action="{{ route('karyawan.kasir.profile.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
